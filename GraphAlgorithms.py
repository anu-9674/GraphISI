...
class GraphAlgorithms:
    ...
    def select_random_samples(json_filepath,num_nodes,num_samples,is_weighted=None,is_directed=None):
        ...
        json_filepath : file where the samples for in-context learning is stored
        num_nodes : number of nodes in graph for which the samples have to be selected
        num_samples : number of samples to be selected - k shot prompting requires k samples
        is_weighted : parameter value is "weighted" or "unweighted" 
        is_directed : parameter value is "directed" or "undirected"
        """
...
class DisjointSet:
    ...
    def find_U_parent(self, node):
        ...
        return self.parent[node]        """Returns K examples to formulate k-shot prompting"""
